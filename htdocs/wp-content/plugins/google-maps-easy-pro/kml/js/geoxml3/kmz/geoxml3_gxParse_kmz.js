  ...
  var render = function (responseXML, doc) {
    ...
    if (!responseXML || responseXML == "failed parse") {
      ...
      for (pm = 0; pm < placemarkNodes.length; pm++) {
        ...
        placemark.vars.val.name = decodeURIComponent(escape(placemark.vars.val.name));
        placemark.vars.val.description = decodeURIComponent(escape(placemark.vars.val.description));
